...
public class Pathfinder
{
    ...
    private static bool EvaluateNextNode(Dictionary<HexTile, Node> nodesNotEvaluated, Dictionary<HexTile, Node> nodesAlreadyEvaluated, HexTile origin, HexTile destination, out List<HexTile> path)
    {
